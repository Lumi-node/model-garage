# Contributing to Model Garage

The most impactful contribution you can make is **adding support for a new model family**.

## Adding a New Model Family

Model Garage uses `ModelDecomposer` classes to understand different architectures. To add a new family:
...
class MyModelDecomposer(ModelDecomposer):
    ...
    def get_module(self, model: nn.Module, part: PartSpec) -> nn.Module:
        # Navigate to module by dot-separated path
        module = model
...
### 2. Add architecture pattern to PyTorchExtractor
